class Zodiacscontroller
  def ram
    ...
    render({ :template => "zodiacs_templates/ram.html.erb" })
  end
  ...
  def bull
    ...
    render({ :template => "zodiacs_templates/bull.html.erb" })
  end
  ...
  def twins
    ...
    render({ :template => "zodiacs_templates/twins.html.erb" })
  end
  ...
  def crab
    ...
    render({ :template => "zodiacs_templates/crab.html.erb" })
  end
  ...
  def lion
    ...
    render({ :template => "zodiacs_templates/lion.html.erb" })
  end
  ...
  def maiden
    ...
    render({ :template => "zodiacs_templates/maiden.html.erb" })
  end
  ...
  def scales
    ...
    render({ :template => "zodiacs_templates/scales.html.erb" })
  end
  ...
  def scorpion
    ...
    render({ :template => "zodiacs_templates/scorpion.html.erb" })
  end
  ...
  def archer
    ...
    render({ :template => "zodiacs_templates/archer.html.erb" })
  end
  ...
  def goat
    ...
    render({ :template => "zodiacs_templates/goat.html.erb" })
  end
  ...
  def waterbearer
    ...
    render({ :template => "zodiacs_templates/waterbearer.html.erb" })
  end
  ...
  def fish
    ...
    render({ :template => "zodiacs_templates/fish.html.erb" })
  end
end
